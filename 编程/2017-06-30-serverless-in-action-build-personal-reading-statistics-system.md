...
上回博客大赛写过一篇 [基于 GitHub 的敏捷学习方法之道与术](https://databasedev.github.io/2016-12-04-agile-learning-based-on-github-issues/)，其中提到使用 GitHub Issue 来管理自己的学习计划，从而就又产生了这么一个想法，就是将我的稍后阅读列表跟 GitHub 结合起来，使用 ZenHub 丰富的图表功能将阅读体系进行追踪与可视化。
...
- [基于 GitHub 的敏捷学习方法之道与术 - 吕立青的博客](https://databasedev.github.io/2016-12-04-agile-learning-based-on-github-issues/)
...
- [个人知识管理：知识的三种形态 - 吕立青的博客](https://databasedev.github.io/2015-10-09-three-types-of-knowledge/)
- [用 GTD 的方法结束稍后读 - 少数派](https://sspai.com/post/33933)
- [不断革新，不断改进：去伪存真的知识管理之路 - 吕立青的博客](https://databasedev.github.io/2016-09-16-sorting-out-knowledge-from-information/)
